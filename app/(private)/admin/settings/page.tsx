...
export default function AdminSettingsPage() {
  ...
  const [siteName, setSiteName] = useState("Popurank")
  ...
  const [seoSettings, setSeoSettings] = useState({
    titleTemplate: "%s | Popurank",
    baseUrl: "https://popurank.com",
    description: "",
    ogTitle: "Popurank - Modern Admin Dashboard",
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g. © 2026 Popurank. All rights reserved."
                  />
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="https://popurank.com"
                  />
                </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          placeholder="Popurank - Modern Admin Dashboard"
                        />
                      </div>
                      <div className="space-y-2">
